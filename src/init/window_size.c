...
static void display_request(WINDOW *screen)
{
...
(int *input, int curr_width, int curr_height, settings_t *settings)
{
    ...
    char msg[] = "Please enter a smaller size than : _\0";
    int msg_pos_x = 0;
    int msg_pos_y = 0;
...
int setup_window_size(settings_t *settings)
{
    ...
    int is_default = 0;
    int size = get_size_from_user(settings, &is_default);
